...
![hqiao](/public/image/嵌入式/传感器/DRV8833/hqiao.png)

**正转**

此时假设电机正转，这电流依次经过 Q1 ， M ， Q4 ，在图中使用黄色线段进行标注，具体如下图所示

![zhengzhuan](/public/image/嵌入式/传感器/DRV8833/zhengzhuan.png)

**反转**

此时电机反转（与前面介绍的情况相反），这电流依次经过 Q2 ， M ， Q3 ，在图中使用黄色线段进行标注，具体如下图所示

![fanzhuan](/public/image/嵌入式/传感器/DRV8833/fanzhuan.png)
...
![yjsm](/public/image/嵌入式/传感器/DRV8833/yjsm.png)
