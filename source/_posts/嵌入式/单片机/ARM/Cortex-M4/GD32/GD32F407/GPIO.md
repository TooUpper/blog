...
在 GD32 系列微控制器中，**GPIO（General Purpose Input/Output）** 是通用输入/输出引脚模块，允许控制和监测外部设备。
...
我在中国，他会不停的给我发送语音邮箱，即使我已经处理过或者使用过 ##004#，他还是会一直频繁的发送
...
![F407huofeimen](/public/image/嵌入式/MCU/ARM/Cortex-M4/GD32/GD32F407/F407F407huofeimen.png)
...
### GPIO 架构
 ...
 CPU 通过 APB 总线操作 GPIO 的实现方式。CPU 通过总线访问 GPIO 寄存器，通过寄存器设置指令传递到控制器，控制器根据寄存器的配置去操控各个 GPIO 端口的引脚（如 PA0、PA1、PF0 等），从而实现引脚的输入输出控制和模式配置。

![F407GPIOshixianyuanli](/public/image/嵌入式/MCU/ARM/Cortex-M4/GD32/GD32F407/F407GPIOshixianyuanli.png)
...
![F407tuiwanshuchushiyitu](/public/image/嵌入式/MCU/ARM/Cortex-M4/GD32/GD32F407/F407tuiwanshuchushiyitu.png)
...
![F407kailoushuchushiyitu](/public/image/嵌入式/MCU/ARM/Cortex-M4/GD32/GD32F407/F407kailoushuchushiyitu.png)
...
![F407gaozushurushiyitu](/public/image/嵌入式/MCU/ARM/Cortex-M4/GD32/GD32F407/F407gaozushurushiyitu.png)
...
![F407tuiwanxianyu](/public/image/嵌入式/MCU/ARM/Cortex-M4/GD32/GD32F407/F407tuiwanxianyu.png)
...
![F407ARMGPIO](/public/image/嵌入式/MCU/ARM/Cortex-M4/GD32/GD32F407/F407ARMGPIO.png)

### GD32/STM32 系列中 GPIO 的工作模式

**浮空输入**

![F407ARMfukongshuru](/public/image/嵌入式/MCU/ARM/Cortex-M4/GD32/GD32F407/F407ARMfukongshuru.png)

**上拉输入**

![F407ARMshanglashuru](/public/image/嵌入式/MCU/ARM/Cortex-M4/GD32/GD32F407/F407ARMshanglashuru.png)

**下拉输入**

![F407ARMxialashuru](/public/image/嵌入式/MCU/ARM/Cortex-M4/GD32/GD32F407/F407ARMxialashuru.png)

**模拟输入**

![F407ARMmonishuru](/public/image/嵌入式/MCU/ARM/Cortex-M4/GD32/GD32F407/F407ARMmonishuru.png)

**推挽输出**

![F407ARMtuiwanshuchu](/public/image/嵌入式/MCU/ARM/Cortex-M4/GD32/GD32F407/F407ARMtuiwanshuchu.png)

**开漏输出**

![F407ARMkailoushuchu](/public/image/嵌入式/MCU/ARM/Cortex-M4/GD32/GD32F407/F407ARMkailoushuchu.png)

**复用推挽输出**

![F407ARMfuyongtuiwanshuchu](/public/image/嵌入式/MCU/ARM/Cortex-M4/GD32/GD32F407/F407ARMfuyongtuiwanshuchu.png)

**复用开漏输出**

![F407ARMfuyongkailou](/public/image/嵌入式/MCU/ARM/Cortex-M4/GD32/GD32F407/F407ARMfuyongkailou.png)
