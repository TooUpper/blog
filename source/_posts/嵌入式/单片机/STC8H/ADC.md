...
ADC(Analog to Digital Converter 模数转换器）是一种将模拟信号转换为数字信号的电路。在电子系统中，模拟信号常常需要转换为数字信号进行处理和存储。模数转换的基本原理是将模拟信号进行**采样**，并将采样值**量化**为数字表示。
...
![image-20240909143656277](C:\Users\kay\AppData\Roaming\Typora\typora-user-images\image-20240909143656277.png)
...
void GPIO_Config(void){
    ...
    // UART 引脚
    GPIO_Init.Pin = GPIO_Pin_0 | GPIO_Pin_0;
...
![image-20240909145514913](C:\Users\kay\AppData\Roaming\Typora\typora-user-images\image-20240909145514913.png)
...
![image-20240909150529465](C:\Users\kay\AppData\Roaming\Typora\typora-user-images\image-20240909150529465.png)

**12位 ADC 采样计算中，2的十二次方最大时4095，为何我们在换算时通常是除以 4096**
